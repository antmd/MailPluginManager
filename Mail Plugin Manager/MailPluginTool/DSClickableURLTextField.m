...
@interface DSClickableURLTextField ()
...
- (void)mouseUp:(NSEvent *)mouseEvent
{
	...
	if ( (urlAtMouse != nil)  &&  [urlAtMouse isEqualTo:clickedURL] ) {
		...
		if ( ([self delegate] == nil)  || ![[self delegate] respondsToSelector:@selector(textField:openURL:)] || ![(NSObject *)[self delegate] textField:self openURL:urlAtMouse] )
